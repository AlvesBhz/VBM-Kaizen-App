/**
 * VBM Kaizen — cadastros bilíngues do admin.html.
 *
 ...
 * modais Add/Edit bilíngues). Por isso as 4 abas são geradas por esta
 * única fábrica, sobre as rotas que server.js registra para cada uma:
 *
...
(function () {
  ...
  // Limites do DER. Categoria é a exceção: colunas já ampliadas no
  // banco (30/100) — mesma nota do server.js.
  var MAX_NOME_DER = 20;
  var MAX_DESC_DER = 40;
  ...
  criarCadastro({
    ...
    maxNome: MAX_NOME_DER, maxDescricao: MAX_DESC_DER,
